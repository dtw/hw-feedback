...
function hw_feedback_activate()
{
  ...
  if (!wp_next_scheduled('hw_feedback_clean_up_temp_cron_job')) {
    // set the first run 10 minutes from "now"
    wp_schedule_event(time() + 600, 'weekly', 'hw_feedback_clean_up_temp_cron_job');
  }
...
function hw_feedback_settings_init()
{
  ...
  add_settings_section(
    ...
    __('CQC API settings', 'hw_feedback'),
    'hw_feedback_section_api_settings_callback',
    'hw_feedback'
  );
  ...
  add_settings_section(
    ...
    __('General', 'hw_feedback'),
    'hw_feedback_section_general_settings_callback',
    'hw_feedback'
  );
  ...
  add_settings_section(
    ...
    __('Moderation', 'hw_feedback'),
    'hw_feedback_section_moderation_settings_callback',
    'hw_feedback'
  );
...
function hw_feedback_field_local_authority_cb($args)
{
  ...
  $options = get_option('hw_feedback_options');
?>
  <select id="<?php echo esc_attr($args['label_for']); ?>" data-custom="<?php echo esc_attr($args['hw_feedback_custom_data']); ?>" name="hw_feedback_options[<?php echo esc_attr($args['label_for']); ?>]">
...
function hw_feedback_field_api_subscription_key_cb($args)
{
  ...
  $options = get_option('hw_feedback_options');
?>
  <input type="text" id="<?php echo esc_attr($args['label_for']); ?>" name="hw_feedback_options[<?php echo esc_attr($args['label_for']); ?>]" value="<?php echo isset($options[$args['label_for']]) ? (($options[$args['label_for']])) : (''); ?>">
  <p class="description">
...
function hw_feedback_field_withheld_comment_text_cb($args)
{
  ...
  $options = get_option('hw_feedback_options');
?>
  <textarea rows="2" wrap="soft" id="<?php echo esc_attr($args['label_for']); ?>" name="hw_feedback_options[<?php echo esc_attr($args['label_for']); ?>]"><?php echo isset($options[$args['label_for']]) ? (($options[$args['label_for']])) : (''); ?></textarea>
  <p class="description">
...
function hw_feedback_field_comment_email_footer_cb($args)
{
  ...
  $options = get_option('hw_feedback_options');
?>
  <textarea rows="5" wrap="soft" id="<?php echo esc_attr($args['label_for']); ?>" name="hw_feedback_options[<?php echo esc_attr($args['label_for']); ?>]"><?php echo isset($options[$args['label_for']]) ? (($options[$args['label_for']])) : (''); ?></textarea>
  <p class="description">
...
function hw_feedback_field_email_from_address_cb($args)
{
  ...
  $options = get_option('hw_feedback_options');
?>
  <input type="email" id="<?php echo esc_attr($args['label_for']); ?>" name="hw_feedback_options[<?php echo esc_attr($args['label_for']); ?>]" value="<?php echo isset($options[$args['label_for']]) ? (($options[$args['label_for']])) : (''); ?>">
  <p class="description">
